...
<?php
		...
		try
		{
			...
			else
			{
				...
				if($how_many>0)
				{
					echo "<table><tr><th>Nazwa</th><th>Minimalna obrona</th><th>Maksymalna obrona</th><th>Minimalna siła</th><th>Wytrzymałość</th></tr>";
					while($row = $result->fetch_assoc()){
						echo "<tr><td>" . $row["Nazwa"]. "</td><td>" . $row["MIN_DEF"]. "</td><td>" . $row["MAX_DEF"]. "</td><td>" . $row["MIN_STR"].  "</td><td>". $row["DUR"].  "</td></tr>";
					}
					echo "</table>";
				}
				else
